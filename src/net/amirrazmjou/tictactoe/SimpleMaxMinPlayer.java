...
public class SimpleMaxMinPlayer implements Player {
    ...
    private int move(Seed currentSeed, Point nextMove) {
        ...
        boolean bMaximizer = currentSeed == seed;
        int score = bMaximizer ? Integer.MIN_VALUE : Integer.MAX_VALUE;
        BiPredicate<Integer, Integer> predicate = (i, j) -> bMaximizer ? i > j : i < j;
